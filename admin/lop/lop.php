...
<div class="content-container">
  ...
  <main>
        ...
        <!-- Quy trình 4 bước -->
        <a href="add.php" class="btn btn-success"><i class="fas fa-user-plus"></i> Thêm Lớp</a>
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">ID</th>
            ...
            <tbody>
                ...
                <?php
                    ...
                    $sql = "SELECT lop.*,lien_khoa.ten_lienkhoa from lop , lien_khoa where lop.id_lienkhoa = lien_khoa.id_lienkhoa ";
                ...
                ?>
                            <tr>
                                ...
                                <td><a href="edit.php?id=<?php echo $row['id_Lop']; ?>"><i class="fas fa-user-edit"></i></a></td>
                                <td><a href="delete.php?id=<?php echo $row['id_Lop']; ?>"><i class="fas fa-user-times"></i></a></td>
                            </tr>
                <?php
                        }
                    }
