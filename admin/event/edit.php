            ...
            <div id="page-inner">
                ...
                <form action="process-edit.php" method="post">
                  ...
                  ?>
                    ...
                    ID:<br>
                    <input type="text" name="sk_id" value="<?php echo $id ?>" class="form-control" readonly><br>
                    Tiêu đề:<br>
                    <input type="text" name="sk_name" value="<?php echo $row['sk_name'] ?>" class="form-control"><br>

                    Ngày tổ chức:<br>
                    <input type="text" name="sk_date" value="<?php echo $row['sk_date'] ?>" class="form-control"><br>

                    Nội dung:<br>
                    <textarea name="sk_des" id="sk_des" rows="25" cols="120"><?php echo $row['sk_des'] ?></textarea>
                    <script>
                    ...
                    <input type="submit" name="sk_picture" class="btn btn-success">
                    <?php 
    }
}
?>
