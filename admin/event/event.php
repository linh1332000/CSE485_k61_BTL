  ...
  <ul class="sidebar-navigation">
    ...
    <li>
      <a href="../user/user.php">
        <i class="fa fa-tachometer fa fa-users" aria-hidden="true"></i> User
      </a>
    </li>
...
<div class="content-container">
  ...
  <main>
        ...
        <!-- Quy trình 4 bước -->
        <a href="add.php" class="btn btn-success"><i class="fas fa-user-plus"></i> Thêm Sự Kiện</a>
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">Id</th>
            ...
            <tbody>
                ...
                ?>
                            <tr>
                                <th scope="row"><?php echo $row['sk_id']; ?> </th>
                                <td><?php echo $row['sk_name']; ?></td>
                                <td><?php echo $row['sk_date']; ?></td>
                                <td><a href="show.php?id=<?php echo $row['sk_id']; ?>"><i class="fas fa-user-edit"></i></a></td>
                                <td><a href="edit.php?id=<?php echo $row['sk_id']; ?>"><i class="fas fa-user-edit"></i></a></td>
                                <td><a href="delete.php?id=<?php echo $row['sk_id']; ?>"><i class="fas fa-user-times"></i></a></td>
                            </tr>
                <?php
                        }
                    }
