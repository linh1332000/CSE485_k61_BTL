        ...
        <main class="container">
            <form action="process-edit.php" method="post">
                <?php
                    ...
                    $sql = "SELECT * from lien_khoa where id_lienKhoa='$id'";
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="id_lienkhoa" name="id_lienkhoa" value="<?php echo $id?>"
                            readonly>
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    <label for="empName" class="col-sm-2 col-form-label">Tên liên khóa:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="ten_LienKhoa" name="ten_LienKhoa"
                            value="<?php echo $row['ten_LienKhoa'] ?>">
                    </div>
                </div>
                <br>
                <?php
