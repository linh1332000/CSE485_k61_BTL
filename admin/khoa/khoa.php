...
<div class="content-container">
  ...
  <main>
        ...
        <!-- Quy trình 4 bước -->
        <a href="add.php" class="btn btn-success"><i class="fas fa-user-plus"></i> Thêm Niên Khóa</a>
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">ID</th>
            ...
            <tbody>
                ...
                ?>
                            <tr>
                                <th scope="row"><?php echo $row['id_LienKhoa']; ?> </th>
                                <td><?php echo $row['ten_LienKhoa']; ?></td>
                                <td><a href="edit.php?id=<?php echo $row['id_LienKhoa']; ?>"><i class="fas fa-user-edit"></i></a></td>
                                <td><a href="delete.php?id=<?php echo $row['id_LienKhoa']; ?>"><i class="fas fa-user-times"></i></a></td>
                            </tr>
                <?php
                        }
                    }
